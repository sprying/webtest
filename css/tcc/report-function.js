...
function freezeTable(table, freezeRowNum, freezeColumnNum, width, height) {
    ...
    divTableFix.add(divTableHead).add(divTableColumn).find('.raCls input,.raCls label').removeAttr('id').removeAttr('for');
...
var fixedFns = function(){
        var table = $(".nsrxxTcc table");
        ...
        if (typeof(freezeRowNum) != 'undefined' || typeof(freezeColumnNum) != 'undefined') {
            return freezeTable(table, freezeRowNum || 0, freezeColumnNum || 0, 800-10, 400-26-15-55);
        }
    }
